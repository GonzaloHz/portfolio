  ...
  return (
    <div className='mt-32 lg:mt-0'>
      <div className='text-center flex flex-col items-center'>
        <div>
          <Image src={isDarkMode ? assets.logo_dark : assets.logo} alt='logo' title='You can help us with a coffee :3' className='w-36 mt-4 lg:mt-0'/>
        </div>
      ...
      <div className='text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6'>
        ...
        <ul>
            <li className='flex gap-10 justify-center items-center mt-4 sm:mt-0'>
                <a href='https://cafecito.app/tostaditoysimon' target='_blank'>CoffeeApp</a>
